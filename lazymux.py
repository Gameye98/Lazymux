...
def main():
	...
	# 06 - Wireless Attack
		...
		print("    [05] PSKracker: PSKracker greatly decreases the time go crack WPA2 PMKIDs from AT&T\'s 3 most common routers 12 length alpha/numeric/symbols")
		print("\n    [00] Back to main menu\n")
		wiretak = input("lzmx > ")
		...
		elif wiretak.strip() == "05" or wiretak.strip() == "5": pskracker()
